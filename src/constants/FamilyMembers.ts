import { Gender, GenderTypesType } from "./Gender";
import { IUserSearchBase } from "./IUserSearchBase";

export const maleFamilyRelationships = [
	"Father",
	"Son",
	"Brother",
	"Uncle",
...
export const femaleFamilyRelationships = [
	"Mother",
	"Daughter",
	"Sister",
	"Aunt",
...
export const genderNeutralFamilyRelationships = [
	"Sibling",
	"Parent",
	"Child",
	"Sibling of Parent",
...
export const getReciprocalRelationship = (
	relationship: keyof typeof FamilyRelationshipOptions,
...
export interface FamilyMember extends Partial<IUserSearchBase> {
